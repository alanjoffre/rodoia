...
| Avaliação de LLMs (LLM-as-judge, guardrails, hallucination) | Fase 1 + 2 + 4 | LLM-as-judge **independente** + faithfulness/relevancy + precisão de citação (F1) · **κ humano inter-anotador 0,86** [IC95 0,65–1,00] (2 anotadores humanos independentes, relevância) + **banca de 3 juízes LLM com κ de Fleiss** · juiz pareado c/ controle de viés (F2) · guardrails |
