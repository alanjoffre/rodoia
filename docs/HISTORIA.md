...
| **5** · ⚙️ | Não quebrar e não piorar | gate **12/12** · drift **0,005** |
...
**Resultado.** **CI verde** com o gate barrando regressão (**12/12 portões**); drift **0,005 (estável)**. O deploy em cloud fica como runbook (decisão de custo); a demo gratuita, **no ar** no HuggingFace Spaces.
