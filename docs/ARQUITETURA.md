...
| Arquivo | O que faz | Funções-chave |
|---|---|---|
| `mlops/gate.py` | Gate de avaliação: regressão de métrica falha o CI (15 portões) | `avaliar`, `GATES`, `_acessar`, `_passou` |
...
- **Gate de qualidade:** `src/rodoia/mlops/gate.py` (pisos por métrica, 15 portões) e o CI em `.github/workflows/ci.yml`.
